...
function click() {
    if (count == 0) {
        ...
        document.getElementById("idimg").src = "../image/draw/draw2.gif";
        ...
        document.getElementById("idimg").src = "../image/draw/false.png"
        ...
        document.getElementById("idimg").src = "../image/draw/true.png"
